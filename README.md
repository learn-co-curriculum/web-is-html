...
Much of that will look like gobbledy-gook right now. That's fine right now. After taking a few lessons on HTML though, parts will start to reveal themselves. While the goal of this course is not to become an HTML expert, we will teach you enough HTML to be a bit dangerous. 
